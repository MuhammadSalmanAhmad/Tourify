...
class CompanyRegisteration extends StatefulWidget {
  const CompanyRegisteration({super.key});

  @override
  State<CompanyRegisteration> createState() => _CompanyRegisterationState();
}

class _CompanyRegisterationState extends State<CompanyRegisteration> {
  void initState() {
    super.initState();
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) =>
                        value!.isEmpty ? 'Enter  a Company Website' : null,
                    decoration: const InputDecoration(
